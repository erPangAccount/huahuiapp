	...
	<view class="container">
		<view class="user-section">
			...
			<view class="user-info-box">
				...
				<view class="info-box">
					<text class="username">{{userInfo.user.nick || userInfo.user.mobile || '游客'}}</text>
				</view>
			</view>
		...
		<view class="cover-container" :style="[{
		 ...
		 @touchstart="coverTouchstart" @touchmove="coverTouchmove" @touchend="coverTouchend">
			...
			<view class="history-section icon">
				...
				<!-- <list-cell icon="icon-shoucang_xuanzhongzhuangtai" iconColor="#54b4ef" title="我的评价" ></list-cell> -->
	...
	export default {
		...
		methods: {
			...
			loadData: function() {
				...
				this.getUserInfo(startCallback, endCallback);
			},
			/**
			 * 统一跳转接口,拦截未登录路由
			...
			//获取用户信息
			getUserInfo: function(startCallback = () => {}, endCallback = () => {}) {
				startCallback();
				let token = this.$ajax.getToken();
				uni.request({
					method: 'GET',
					url: this.$ajax.ajaxBaseUrl + '/api/customer',
					dataType: 'json',
					header: {
